...
public class FrameDepartment implements Serializable {
	...
	private String dept_type_id;

	private String extend_type_id;
	...
	public String getExtend_type_id() {
		return extend_type_id;
	}
	...
	public void setPara_seq(String para_seq) {
		this.para_seq = para_seq;
	}
	...
	public void setExtend_type_id(String extend_type_id) {
		this.extend_type_id = extend_type_id;
	}
