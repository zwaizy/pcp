 ...
 */
@Repository
public class UserRoleDaoImpl extends JdbcDaoImpl implements UserRoleDao {
	
	@Override
	public List<UserRole> listByUserCode(String userCode) {
		String sql = "select * from user_role where user_code = ? ";
		return queryForObjectList(sql, UserRole.class, userCode);
	}
